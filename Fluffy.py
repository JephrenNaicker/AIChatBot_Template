...
} # Profile schema dictionary here
BOTS = [
    {
        "name": "StoryBot",
        "emoji": "📖",
...
] # Tag options list here
AUDIO_BASE_DIR = "C:/Users/Jephren Naicker/Desktop/Python/FluffyAi/Audio"
...
class Utils:
    ...
    def create_placeholder_avatar():
        ...
        d.text((50, 50), "👑", fill=(255, 255, 0), anchor="mm")
        return img
...
def main():
    ...
    if st.session_state.page == "home":
        PagesManager.home_page()
    elif st.session_state.page == "profile":
        PagesManager.profile_page()
    elif st.session_state.page == "chat":
        PagesManager.chat_page(st.session_state.selected_bot)
    elif st.session_state.page == "bot_setup":
        PagesManager.bot_setup_page()
    elif st.session_state.page == "generate_concept":
        PagesManager.generate_concept_page()
    elif st.session_state.page == "create_bot":
        PagesManager.create_bot_page()
    elif st.session_state.page == "my_bots":
        PagesManager.my_bots_page()
    elif st.session_state.page == "edit_bot":
        PagesManager.edit_bot_page()
    elif st.session_state.page == "voice":
        PagesManager.voice_page()
    elif st.session_state.page == "group_chat":
        PagesManager.group_chat_page()
    else:
